...
export const videoPlayerInit = () => {
    ...
    const toggleOff = () => {
        if (videoVolume.select) {
          videoPlayer.volume = 0;
          videoVolume.value = 0;
        } else if (videoVolume.select) {
          videoPlayer.volume = videoVolume.value / 100;
          videoVolume.value = videoPlayer.volume * 100;
        } else {
    ...
    faVolumeDown.addEventListener('click', mutedVol);
    faVolumeUp.addEventListener('click', unmutedVol);
    faVolumeOff.addEventListener('click', toggleOff);
